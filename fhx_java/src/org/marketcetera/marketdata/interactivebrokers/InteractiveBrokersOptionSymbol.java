...
@ClassVersion("$Id: MarketceteraOptionSymbol.java 10309 2009-02-09 20:04:30Z anshul $") //$NON-NLS-1$
public class InteractiveBrokersOptionSymbol 
    extends MSymbol 
    implements IEquityOptionSymbol, Messages
{
	...
	public InteractiveBrokersOptionSymbol(String symbolString) {
		super(symbolString);
