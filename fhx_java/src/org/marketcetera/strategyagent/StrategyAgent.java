 ...
 */
@ClassVersion("$Id: StrategyAgent.java 10445 2009-04-03 01:10:29Z anshul $") //$NON-NLS-1$
...
System.out.println("XXXX java.class.path: " + System.getenv("java.class.path"));
System.out.println("XXXX Starting SA: " + args[0]);
        ...
        System.out.println("XXXX Stop SA: " + args[0]);
    }
